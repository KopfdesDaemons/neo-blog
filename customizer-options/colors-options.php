...
function neo_blog_custom_colors($wp_customize)
{
    // Section
    ...
    $wp_customize->add_setting('dark_mode', array(
        'default' => 'dark',
        'transport' => 'refresh',
        'sanitize_callback' => 'neo_blog_sanitize_dark_mode_option',
    ));
...
add_action('customize_register', 'neo_blog_custom_colors');


function neo_blog_sanitize_dark_mode_option($input)
{
...
add_action('wp_head', 'neo_blog_add_darkmode_class_to_html', 999);
