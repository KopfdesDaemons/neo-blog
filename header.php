...
<head>
    ...
    list($primary_hue, $saturation, $lightness) = neo_hex2hsl($neo_primary_color);
    ...
    <style>
        ...
        ?>:root {
            ...
            --neo_element_background_inputfeld: <?php echo $neo_background_inputfield ?>;
            --neo_element_background_variant: <?php echo $neo_background_variant ?>;
            --neo_element_background_variant_darker: <?php echo $neo_background_variant_darker ?>;
            ...
            --neo_header_gap: <?php echo esc_attr(get_theme_mod('header_gap', '0')) . 'em';
                                ?>;
            /* Font Settings */
            ...
            /* Comments Settings */
            --neo_comments_border_radius: <?php echo esc_attr(get_theme_mod('comments_border_radius', '12') . 'px');
                                            ?>;
            --neo_comments_inner_glow: <?php echo esc_attr(get_theme_mod('comments_inner_glow', '50') . 'px');
                                        ?>;
            ...
            --neo_comments_reply_link_position: <?php echo esc_attr(get_theme_mod('comments_reply_link_position', 'flex-start'));
                                                ?>;
            --neo_comments_name_font_size: <?php echo esc_attr(get_theme_mod('comments_name_font_size', '14')) . 'px;';
                                            ?>;
            --neo_comments_max_height: <?php echo esc_attr(get_theme_mod('comments_max_height', '400') . 'px');
                                        ?>;
            --neo_comments_date_position: <?php echo esc_attr(get_theme_mod('comments_date_position', 'row'));
                                            ?>;
        }
        ...
        ?>.neo_dark_mode {
            ...
            --neo_element_background_variant_darker: <?php echo $neo_background_variant ?>;
        }
...
<body <?php body_class(); ?>>
    <?php wp_body_open(); ?>
    <?php $neo_header_fixed = get_theme_mod('fixed_header', false); ?>
    <header class="neo_header <?php if ($neo_header_fixed) echo 'neo_header_fixed' ?>" role="banner">
        <div class="neo_header_div">
            ...
            if ($title) {
                ...
                echo '<div class="neo_header_title_div"><a href="' . esc_url(home_url('/')) . '">
                    <span class="neo_header_title_span">' . esc_html($title) . '</span>
                </a>
            </div>';
            }
            ?>
            ...
            if ($tagline) {
                ...
                echo '<div class="neo_header_slogan_div"><span>' . esc_html($description) . '</span></div>';
            }
            ?>
            ...
            if ($image_url) {
                echo '<img class="neo_header_banner" src="' . esc_url($image_url) . '" alt="Header Banner">';
            }
            ?>

            <!-- Toggle button, Menu and Search -->
            <div class="neo_header_toggle_row">
                <?php
                $home_page_link = get_theme_mod('home_page_link', true);
                if ($home_page_link) { ?>
                    <a href="/" class="neo_header_home_link" title="<?php echo __('Home page', 'neo') ?>">
                ...
                $header_menu_style_is_horizontal = get_theme_mod('header_menu_style', 'horizontal') == 'horizontal';
                if ($header_menu_is_activ & !$header_menu_style_is_horizontal) { ?>
                    <button id="neo_header_menu_button" onclick="neo_toggle_menu()"><i class="fa-solid fa-bars"></i></button>
                <?php }
                $searchbar = get_theme_mod('searchbar', false);
                if ($searchbar) {
                    echo '<div class="neo_header_search_row"><div class="neo_header_search_div">';
                ...
                <nav class="neo_header_menu_nav">
                    ...
                    if ($header_menu_is_activ & !$header_menu_style_is_horizontal) {
                        wp_nav_menu(array(
                            ...
                            'menu_class' => 'neo_header_menu_vertical'
                        ));
                    }
                    if ($header_menu_is_activ & $header_menu_style_is_horizontal) {
                        wp_nav_menu(array(
                            'theme_location' => 'header-menu',
                            'menu_class' => 'neo_header_menu_horizontal'
                        ));
                    }
                    ?>
                </nav>
